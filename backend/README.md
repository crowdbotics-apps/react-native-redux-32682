...
## Project Structure
    ...
    ├── react_native_redux_32682  # Django project configurations
...
1. Clone this repo and `cd react_native_redux_32682`
...
2. Clone this repo and `cd react_native_redux_32682`
